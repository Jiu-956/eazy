<template>
  <div class="container">
    <a-card class="general-card" :bordered="false">
      ...
      <!-- 顶部统计卡 -->
      <div class="stats-row" style="margin: 20px 0; display: flex; gap: 16px;">
        <a-card style="flex: 1; padding: 16px; text-align: left;">
        ...
        <a-card style="flex: 1; padding: 16px; text-align: left;">
          ...
          <div style="font-size: 20px; font-weight: 600; color: var(--color-success);">
            1
          </div>
        </a-card>
        <a-card style="flex: 1; padding: 16px; text-align: left;">
          ...
          <div style="font-size: 20px; font-weight: 600; color: var(--color-warning);">
            1
          </div>
        </a-card>
      </div>
